...
class Visualizer: 
	...
	def update_smpl_multi_view_callback(self,sample,video_dir=None):
		...
		ps_biomechnical = ps.register_surface_mesh("Biomechnical Model",sample.osim.vertices[0],sample.osim.faces,transparency=0.7,color=np.array([1,1,1]))
		ps_biomechnical_joints = ps.register_point_cloud("Biomechnical Joints",sample.osim.joints[0],color=np.array([0,0,0]))
